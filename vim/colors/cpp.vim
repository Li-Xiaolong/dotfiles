...
if exists('g:cpp_class_scope_highlight') && g:cpp_class_scope_highlight
    ...
    hi def link cCustomClass  ClassName 
endif
...
if exists('g:cpp_class_decl_highlight') && g:cpp_class_decl_highlight
	...
	syn match cCustomClassName "\<protected\_s\+\w\+\>"
				\ contains=cCustomAccessKey
	hi def link cCustomClassName ClassName 

    " C++:
    "call <sid>hi('podType', s:cdBlue, {}, 'none', {}) 
    syntax keyword podType bool 
    syntax keyword podType int
    syntax keyword podType float
    syntax keyword podType double
    syntax keyword podType auto
    syntax keyword podType void
    syntax keyword podType unsigned
    syntax keyword podType signed
    syntax keyword podType short
    syntax keyword podType long
    syntax keyword podType char
    syntax keyword podType int
    syntax keyword podType const
    syntax keyword podType sizeof
    syntax keyword podType nullptr
    syntax keyword podType typeid
    syntax keyword podType static
    syntax keyword podType volatile
    syntax keyword podType virtual
    syntax keyword podType explicit
    syntax keyword podType mutable
    syntax keyword podType override
    syntax keyword podType try
    syntax keyword podType catch
    syntax keyword podType throw
    syntax keyword podType do 
    syntax keyword podType while
    hi def link podType Keyword
